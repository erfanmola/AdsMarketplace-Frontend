import type TAnimator from "./animator";
import type TAreas from "./areas";
import type TBars from "./bars";
import type TChart from "./chart";
import type { getLabelDate, getLabelTime } from "./format";
import type TLines from "./lines";
...
export type TChartAnimationProperty<S = TChartState> = {
	prop: keyof S;
	state: S;
	end: number;
	duration: number;
...
export type TChartAnimationItem = {
	...
	"cbEnd" | "state" | "end" | "tween" | "speed" | "group"
>;
